...
/// <see cref="SpawnEntity"/>.
/// </summary>
[CreateAssetMenu(fileName = "NewSpawnBlueprint", menuName = "EntitasRedux/Spawn/SpawnBlueprint")]
public partial class SpawnBlueprint : BlueprintBase, ISpawnBlueprint
{
	/// <summary>
	/// Applies all components in the blueprint to <paramref name="entity"/>.
	/// </summary>
	/// <param name="entity"></param>
	public void ApplyToEntity(SpawnEntity entity)
	{
		for (var i = 0; i < _components.Count; i++)
		{
			...
			var index = SpawnComponentsLookup.GetComponentIndex(component);
			if (index != -1)
			{
	...
	protected override void OnValidate()
	{
		...
		{
			var index = SpawnComponentsLookup.GetComponentIndex(_components[i]);
			if (index == -1)
			{
